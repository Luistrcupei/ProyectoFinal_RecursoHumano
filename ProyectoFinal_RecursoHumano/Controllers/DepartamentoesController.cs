...
namespace ProyectoFinal_RecursoHumano.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Codigo_Depart,Nombre")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Codigo_Depart,Nombre")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
